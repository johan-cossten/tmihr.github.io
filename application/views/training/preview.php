                    ...
                    <div class="row invoice-info">
                        <div class="col-sm-4 invoice-col" id="preview_data">
                            ...
                            <table width="1020" border="0" cellpadding="0" cellspacing="0" style='border-collapse:collapse;table-layout:fixed;'>
                                ...
                                <col width="17" style='mso-width-source:userset;mso-width-alt:621;' />
                                <col width="18" style='mso-width-source:userset;mso-width-alt:658;' />
                                <col width="34" style='mso-width-source:userset;mso-width-alt:1243;' />
                                <col width="85" style='mso-width-source:userset;mso-width-alt:3108;' />
                                <col width="51" style='mso-width-source:userset;mso-width-alt:1865;' />
                                <col width="57" style='mso-width-source:userset;mso-width-alt:2084;' />
                                <col width="47" style='mso-width-source:userset;mso-width-alt:1718;' />
                                <col width="64" style='width:48,00pt;' />
                                <col width="27" style='mso-width-source:userset;mso-width-alt:987;' />
                                <col width="116" style='mso-width-source:userset;mso-width-alt:4242;' />
                                <col width="74" style='mso-width-source:userset;mso-width-alt:2706;' />
                                <col width="64" style='width:48,00pt;' />
                                <col width="41" style='mso-width-source:userset;mso-width-alt:1499;' />
                                <col width="15" style='mso-width-source:userset;mso-width-alt:548;' />
                                <col width="64" style='width:48,00pt;' />
                                <col width="86" style='mso-width-source:userset;mso-width-alt:3145;' />
                                <col width="17" style='mso-width-source:userset;mso-width-alt:621;' />
                                <col width="31" style='mso-width-source:userset;mso-width-alt:1133;' />
                                <col width="88" style='mso-width-source:userset;mso-width-alt:3218;' />
                                <col width="17" style='mso-width-source:userset;mso-width-alt:621;' />
                                ...
                                <tr height="20" style='height:15.00pt;'>
                                    ...
                                    <td colspan="4"></td>
                                    <td class="xl90" colspan="2" style='border-right:none;border-bottom:.5pt solid windowtext;' x:str></td>
                                ...
                                <tr height="20" style='height:15.00pt;'>
                                    ...
                                    <td class="xl90" colspan="3" style='border-right:.5pt solid windowtext;border-bottom:.5pt solid windowtext;' x:str>SCORE :</td>
                                    <td class="xl81"></td>
                                    <td class="xl841" x:num><?= isset($POINT_REPROT) ? $POINT_REPROT : '' ?></td>
                                    <td class="xl97"></td>
                                </tr>
                                <tr height="20" style='height:15.00pt;'>
                                    <td height="20" style='height:15.00pt;'></td>
