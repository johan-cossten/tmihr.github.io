                            ...
                            <table frame=void cellspacing=0 cols=0 rules=none border=0>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-bottom: 1px solid #000000" colspan=3 align=left><?= isset($date7) ? date('d-m-Y', strtotime($date7)) : '' ?></td>
                                        <td align=left></td>
                                        <td align=left></td>
                                        <td align=left>
                                            Date :
                                        </td>
                                        <td style="border-bottom: 1px solid #000000" colspan=4 align=left><?= isset($date7) ? date('d-m-Y', strtotime($date7)) : '' ?></td>
                                        <td align=left></td>
                                    </tr>
                                    <tr>
                                        <td height=17 align=left></td>
