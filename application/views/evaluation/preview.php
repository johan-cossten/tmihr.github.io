                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan=2 style="border-bottom: 1px solid #000000" align=left>
                                            <?= isset($PLN_PLAN_QTY) || isset($PLN_PLAN_UNIT) ? $PLN_PLAN_QTY . ' ' . $PLN_PLAN_UNIT : '' ?>
                                        </td>
                                        <td align=left>(from)</td>
                                        <td colspan=2 style="border-bottom: 1px solid #000000" colspan=2 align=left>
                                            <?= isset($PLN_EN_DT) ? date('d-m-Y', strtotime($PLN_EN_DT)) : '' ?>
                                        </td>
                                        <td style="border-bottom: 1px solid #000000" align=left></td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-bottom: 1px solid #000000" colspan=3 align=left><?= isset($PLN_EN_DT) ? date('d-m-Y', strtotime($date7)) : '' ?></td>
                                        <td align=left></td>
                                        <td align=left></td>
                                        <td align=left>
                                            Date :
                                        </td>
                                        <td style="border-bottom: 1px solid #000000" colspan=4 align=left><?= isset($PLN_EN_DT) ? date('d-m-Y', strtotime($date7)) : '' ?></td>
                                        <td align=left></td>
                                    </tr>
                                    <tr>
                                        <td height=17 align=left></td>
...
<script>
    $(".evaluation-view-active-li").addClass("active");
</script>
