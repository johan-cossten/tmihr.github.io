        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1>
                    ...
                    <small>View/Search Training Evaluation</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li class="active">Training Evaluation List</li>
                </ol>
            </section>
            <?php
            $CI = &get_instance();
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <?php if ($CI->permission('trainingevaluation_add')) { ?>
                                    <div class="box-tools">
                                        <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>evaluation/add">
                                            <i class="fa fa-plus"></i> Add Evaluation</a>
                                    </div>
                                <?php } ?>
                            </div>
                            <!-- /.box-header -->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#example2').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('evaluation/ajax_list') ?>",
                    "type": "POST",
