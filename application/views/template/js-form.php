...
<script>
    ...
    function get_start_date() {
        return $('#daterange-btn').data('daterangepicker').startDate.format('dd-mm-yyyy');
        var end_date = $('#daterange-btn').data('daterangepicker').endDate.format('dd-mm-yyyy');
    }

    function get_end_date() {
        return $('#daterange-btn').data('daterangepicker').endDate.format('dd-mm-yyyy');
    }
</script>
<!-- Initialize toggler -->
<script type="text/javascript">
