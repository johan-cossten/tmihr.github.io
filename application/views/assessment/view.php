...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="view_assessment_modal"></div>
            <!-- Main content -->
                        ...
                        <div class="box">
                            <div class="box-header with-border">
                                ...
                                <?php if ($CI->permission('assessment_add')) { ?>
                                    <div class="box-tools">
                                        <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>assessment/add">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $('#example2').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('assessment/ajax_list') ?>",
                    "type": "POST",
    ...
    <script>
        $(".assessment-view-active-li").addClass("active");
    </script>
</body>
